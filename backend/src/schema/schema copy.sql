...
-- Insert into Policy_Procedure_Type (required for Policy_and_Procedure.Type)
INSERT INTO Policy_Procedure_Type (Name, Created_By) VALUES
('Health and Safety', 'admin'),
('Compliance', 'admin'),
('Operational', 'admin');

-- Insert into Policy_Procedure_Field (required for Policy_and_Procedure.Field)
INSERT INTO Policy_Procedure_Field (Name, Created_By) VALUES
('Compliance', 'admin'),
('Training', 'admin'),
('Safety Protocols', 'admin');

-- Insert into Policy_and_Procedure (corrected to align with existing data)
...
-- Insert into Hampers (required for Food_Assistance.Hamper_Type)
INSERT INTO Hampers (Name, Created_By) VALUES
('Basic Food Hamper', 'admin'),
('Emergency Food Hamper', 'admin'),
('Special Dietary Hamper', 'admin');

-- Insert into Food_Assistance (corrected to align with Hampers table)
