...
const FinancialAssistanceReport = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(GET_FINANCIAL_ASSISTANCE_REPORT, {
                headers: {
    ...
    const totalAmount = data.reduce((sum, item) => sum + (parseFloat(item.financial_amount) || 0), 0);
                        ...
                        <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div className="page-title-right">
                                <ol className="breadcrumb m-0">
                                    ...
                                    <li className="breadcrumb-item active">Financial Assistance</li>
                                </ol>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col lg={3} md={6}>
                        <Card className="card-animate">
                            <CardBody>
                                <div className="d-flex align-items-center">
                                    <div className="flex-grow-1 overflow-hidden">
                                        <p className="text-uppercase fw-medium text-muted text-truncate mb-0">Total Amount</p>
                                    </div>
                                    <div className="flex-shrink-0">
                                        <h5 className="text-success fs-14 mb-0">{formatCurrency(totalAmount)}</h5>
                                    </div>
                                </div>
                            </CardBody>
                        </Card>
                    ...
                    <Col lg={3} md={6}>
                        <Card className="card-animate">
                            <CardBody>
                                <div className="d-flex align-items-center">
                                    <div className="flex-grow-1 overflow-hidden">
                                        <p className="text-uppercase fw-medium text-muted text-truncate mb-0">Average Amount</p>
                                    </div>
                                    <div className="flex-shrink-0">
